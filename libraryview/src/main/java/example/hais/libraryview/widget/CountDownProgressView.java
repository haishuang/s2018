package example.hais.libraryview.widget;
...
import example.hais.libraryview.R;
...
public class CountDownProgressView   extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mArcRectF, -90, -360 * progress / 100, false, mPaint); //这里的-90.是方向，大家可以改成0，90，180，-90等就可以看到效果区别,-360 * progress / 100绘制的角度
    }
